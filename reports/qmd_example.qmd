...
Image("../results/horse_pops_plot.png")
```
...
```{python}
#| echo: false
#| label: fig-horse-pops-largest-sd
#| fig-cap: "Horse populations for the province with the largest standard deviation."
#| out-width: "65%"
Image("../results/horse_pops_plot_largest_sd.png")
```

In @fig-horse-pops-largest-sd we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
